...
SECRET_KEY = 'django-insecure-=p_n43d%ys68e-46d3hu0d*zfk-#8-dovj2=gme#+9&+0la^!@'
...
TEMPLATES = [
    {
        ...
        # THIS allows global templates (like account/login.html)
...
# Changed to your local timezone
